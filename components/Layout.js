            ...
            <footer className="bg-gray-900 text-gray-300 pt-16 pb-8">
                <div className="max-w-6xl mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-gray-800">
                        <div>
                            <h3 className="text-white font-bold text-xl mb-4">DnG Worldwide Botswana</h3>
                        ...
                        <div>
                            ...
                            <ul className="text-sm space-y-2.5">
                                ...
                                <li className="text-gray-400 break-all">
                                    <a href="mailto:dngworldwidebotswana@gmail.com" className="hover:text-green-400 transition-colors">
                                        dngworldwidebotswana@gmail.com
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="pt-8 text-center text-xs text-gray-500">
                        © {new Date().getFullYear()} DnG Worldwide Botswana. All rights reserved.
                    </div>
                </div>
            </footer>
